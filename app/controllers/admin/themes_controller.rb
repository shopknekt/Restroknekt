class Admin::ThemesController < ApplicationController
  ...
  before_action :authenticate_super_admin!, only: [:new, :create, :destroy]
  ...
  private
    ...
    def theme_params
      params.require(:theme).permit(:theme_name, :description, :status)
    end

    def authenticate_super_admin!
    if current_shop_admin.is_super_admin?
      return true
    else
